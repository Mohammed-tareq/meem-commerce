...
if (!defined('QUANTITY_EXCEEDS_AVAILABLE_STOCK')) {
    define('QUANTITY_EXCEEDS_AVAILABLE_STOCK', APP_NOTICE_DOMAIN . 'ERROR.QUANTITY_EXCEEDS_AVAILABLE_STOCK');
}
if (!defined('PRODUCT_EXCEEDS_AVAILABLE_STOCK')) {
    define('PRODUCT_EXCEEDS_AVAILABLE_STOCK', APP_NOTICE_DOMAIN . 'ERROR.PRODUCT_EXCEEDS_AVAILABLE_STOCK');
}
